...
LOG_PATH         = "/Users/thomashammock/Flock/Reports/flock_run_log_reno.csv"
# ─────────────────────────────────────────────
...
def build_email_body(success, log_path, error_details=None):
    ...
    sections = [
        "Reno Flock Automation Daily Report",
...
def send_flock_report(success: bool, log_path: str = LOG_PATH, error_details: str = None):
    ...
    subject = f"Reno Flock Automation -- {status_label} | {now}"
