...
**Last Updated:** May 26, 2026 (added: §5C Key Finding 5 — OMNIA contract Section 4.3 perpetual anonymized/derived-data rights granted to Flock, including ML training use; BOS deliberation gap documented; Oshkosh parallel noted)
**Previously:** May 19, 2026 (added: Phase 2 CPRA final response #26-245 documented — full response by category, three flagged issues, 263/2025 identity confirmed; FBI nationwide ALPR procurement finding — national infrastructure context updated in conclusion table and §1D)
...
- **Key finding 5 — Section 4.3 (Anonymized Data):** Flock retains a **non-exclusive, worldwide, perpetual, royalty-free right** to collect, analyze, and anonymize Customer Data and Customer Generated Data — and to use and distribute the resulting anonymized data, including explicitly for training machine learning algorithms and creating future Flock products. The headline data-ownership language ("Flock does not own and shall not sell Customer Data") appears in §§ 4.1 and 4.2 but does not govern anonymized/derived data. Section 4.3 is a separate grant running alongside customer ownership of raw footage. The BOS-signed contract authorized this; nothing in any BOS agenda item flagged it for deliberation. This is the structural parallel to the Oshkosh, Wisconsin case (city council rescinded contract after officials said they received false or misleading information about system capabilities) and to the DeFlock BCS / Reddit community finding circulating as of May 2026.

**Evidentiary role:** The OMNIA contract was independently obtained from the BOS's own public agenda portal after YCSO withheld it in CPRA response — the contrast between YCSO's withholding and the document's availability on the BOS's own portal is a documentable contradiction presentable to the BOS. The Section 4.3 finding adds a second layer: the BOS authorized perpetual derived-data rights for Flock without those rights being surfaced as a deliberative question. The framing is not that Flock misled anyone — it is that the contract structure was not presented to the Board in a way that enabled informed consent. Combined with Key Finding 1 (no proprietary information certification), this closes the loop: Flock cannot claim trade secrecy over contract terms that a publicly elected board signed without full deliberation of their scope.
