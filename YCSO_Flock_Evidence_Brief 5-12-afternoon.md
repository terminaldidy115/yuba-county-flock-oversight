...
**Last Updated:** May 12, 2026 (added: HIBF dataset findings §1E; "game changer" national pattern §4D; Option C governance framing in conclusion)
...
1. [Pillar 1 — SB 34 / Civil Code §§ 1798.90.5 et seq. Compliance Failures](#pillar-1)
   - 1A. Blank Reason Rate: ~53% of Searches Undocumented
...
### Phase 2 CPRA — Filed May 9, 2026
**Filed to:** Custodian of Records, Yuba County Sheriff's Office, 215 Fifth Street, Marysville, CA 95901
**Reference:** Prior requests 26-97 and 26-136
**10-day determination deadline:** ~May 19, 2026
...
|---|---|
| **Officer level** | ~53% of searches undocumented; operationally specific queries (make/model/color/partial plate) with blank reason fields; case number entries substituting for purpose statements |
...
| **Federal level** | JAG grant conditions impose additional obligations; compliance documentation requested in Phase 2 CPRA (filed May 9, 2026; deadline ~May 19, 2026) |
| **National level** | The governance failures documented here are not unique to YCSO — agencies across the country deploying Flock show the same pattern; Shorewood IL shut down cameras after two years of mandatory-audit non-compliance |
