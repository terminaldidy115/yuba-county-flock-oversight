...
LOG_PATH         = "/Users/thomashammock/Desktop/Flock/Reports/flock_run_log.csv"
# ─────────────────────────────────────────────
...
def send_flock_report(success: bool, log_path: str = LOG_PATH, error_details: str = None):
    ...
    subject = f"Flock Automation -- {status_label} | {now}"
